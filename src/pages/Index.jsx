...
const Index = () => {
  return (
    <Container maxW="container.xl" p={4}>
      {/* Hero Section */}
      <Flex alignItems="center" justifyContent="center" direction="column" my={12} w="100%" bgGradient="linear(to-r, brand.900, brand.700)">
        <VStack align="center" w="100%" spacing={6}>
          ...
          <Button leftIcon={<FaPlay />} bgGradient="linear(to-r, brand.900, brand.700)" colorScheme="black" size="lg">
            Listen Now
          </Button>
        </VStack>
      ...
      <Flex as="section" direction={{ base: "column", md: "row" }} justifyContent="space-between" alignItems="center" p={12} my={12} bgGradient="linear(to-l, brand.800, brand.700)" borderRadius="lg">
        <Heading as="h3" size="lg">
          Subscribe to our Podcast
        </Heading>
        <Stack direction="row" mt={{ base: 4, md: 0 }} spacing={4}>
          <Button aria-label="Spotify" leftIcon={<FaSpotify />} bgGradient="linear(to-r, brand.900, brand.700)" />
          <Button aria-label="Apple Podcasts" leftIcon={<FaApple />} bgGradient="linear(to-r, brand.900, brand.700)" />
          <Button aria-label="Google Podcasts" leftIcon={<FaGoogle />} bgGradient="linear(to-r, brand.900, brand.700)" mr={4} />
          <Button aria-label="Instagram" leftIcon={<FaInstagram />} bgGradient="linear(to-r, brand.900, brand.700)" />
          <Button aria-label="TikTok" leftIcon={<FaTiktok />} bgGradient="linear(to-r, brand.900, brand.700)" />
        </Stack>
      </Flex>
    </Container>
  );
